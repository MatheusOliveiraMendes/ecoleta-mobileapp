  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Image style={styles.pointImage} source={{ uri: 'https://senacblog.s3.sa-east-1.amazonaws.com/wp-content/uploads/2020/08/18173222/Reciclagem-em-casa.png' }} />

        <Text style={styles.pointName}>Ponto de Coleta</Text>
        <Text style={styles.pointItems}>Papeis e Papelão, Residuos Eletronicos</Text>
